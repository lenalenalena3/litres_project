...
<img src="images/litres_web.jpg" alt="Image litres_web" width="400"><img src="images/litres_mobile.jpg" alt="litres_mobile" width="400">
...
* ✅ UI: Главное меню: Проверка названий верхнего меню
* ✅ UI: Главное меню: Проверка поиска
* ✅ UI: Книжная страница: Просмотр оглавления
* ✅ UI: Личный кабинет: Добавление книги в список 'Отложено'
* ✅ UI: Личный кабинет: Удаление книги из списка 'Отложено'
* ✅ UI: Личный кабинет: Добавление книги в корзину
* ✅ UI: Личный кабинет: Удаление книги из корзины
